...
<div class="row">
	<div class="col-md-3 col-xs-12">
		<form:form class="form-inline" action="/admin/brand" method="GET"
	...
	<div class="col-md-7 col-xs-12">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/brand"
					method="POST" modelAttribute="brand" enctype="multipart/form-data">
		...
		<c:forEach items="${page.content}" var="brand">
			<div class="row">
				<div class="col-md-3 col-xs-3">
					<img width="100%"
						src="/images/brand/${brand.id}.jpg?version=${brand.version}">
				</div>
				<div class="col-md-3 col-xs-3">${brand.name}</div>
				<div class="col-md-3 col-xs-3">
					<a class="btn btn-warning"
						href="/admin/brand/update/${brand.id}<custom:allParams/>">update</a>
				</div>
				<div class="col-md-3 col-xs-3">
					<a class="btn btn-danger"
						href="/admin/brand/delete/${brand.id}<custom:allParams/>">delete</a>
				</div>
			</div>
		</c:forEach>
	</div>
